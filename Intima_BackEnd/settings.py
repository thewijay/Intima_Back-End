"""
Django settings for Intima_BackEnd project.
...
SECRET_KEY = 'django-insecure-6knk$on!vji@4u$ulbeowc6*l2jgc@k2lsoy0202%_v6w-fjo$'
...
SIMPLE_JWT = {
    ...
    'SIGNING_KEY': 'your-secret-key',  # Replace this with a secure secret key
